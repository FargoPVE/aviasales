...
CREATE TABLE passenger(
    ...
    INDEX passenger_firstname_lastname_idx(firstname, lastname)
);
...
CREATE TABLE flight(
	...
	departure_city BIGINT UNSIGNED,
	departure_time DATETIME,
	arrival_city BIGINT UNSIGNED,
...
CREATE TABLE airplane(
	...
	INDEX airplane_id_model_board_number_idx(id_model, board_number)
);
...
CREATE TABLE airplane_model(
	...
	FOREIGN KEY (id_model) REFERENCES airplane(id),
	FOREIGN KEY (id_airplane_type) REFERENCES airplane_types(id)
);
...
CREATE TABLE country(
	...
	INDEX country_rus_name_eng_name_idx(russian_name, english_name)
);
...
CREATE TABLE city(
	...
	INDEX city_rus_name_eng_name_idx(russian_name, english_name)
);
...
FOREIGN KEY (departure_city) REFERENCES aviasales.city(id);

ALTER TABLE aviasales.flight 
ADD CONSTRAINT flight_FK_1 
FOREIGN KEY (arrival_city) REFERENCES aviasales.city(id);

ALTER TABLE aviasales.route 
ADD CONSTRAINT route_FK 
FOREIGN KEY (departure_city) REFERENCES aviasales.city(id);
